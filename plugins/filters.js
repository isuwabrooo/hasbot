...
const array = ['Aliya','Aliyo','Aysheri','Call','Chaya','Corona','Cr7','Error','Exam potti','Fuck','Gd nyt','Goal','Gud nyt','HB DAY','HBD','Happy Birthday','Help','Hi','Hmm','Hy','Jimbrootan','Life','Line','Loo','Look','Mmm','Oru doubt','Seth po','Single','Welcome','aara','alive','bot','chill','enik pediya','ennitt','entha','exam','good night','group','grp','ha','hacker','he he','helo','kandatha','line','manasilayo','mention','samshayam','save','thech']
array.map( async (a) => {
