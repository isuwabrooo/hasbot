...
module.exports = {
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://i.imgur.com/KLDwDSY.gif' : process.env.GIF_WEL,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/k6SLze9.gif' : process.env.GIF_BYE,
