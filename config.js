...
module.exports = {
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://i.imgur.com/7GooE4O.mp4' : process.env.GIF_WEL,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/PLEz6hZ.mp4' : process.env.GIF_BYE,
